...
// Representing the add income screen
public class AddIncomePanel extends JPanel {
    ...
    public AddIncomePanel(int width, int height, Gui gui) {
    ...
    private void addTitle() {
        ...
        titleLabel.setText("Add a new income");
    ...
    private void createAddButton() {
        ...
        button.addActionListener(evnt -> mainInterface.addIncome(name.getText(), value.getText(),
